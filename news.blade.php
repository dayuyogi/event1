  		...
  		<div class="box box-info">
                  ...
                  {!! csrf_field() !!}
                    ...
                    <div class="form-group{{ $errors->has('news_author') ? ' has-error' : '' }}">
                            <label for="news_author" class="col-md-2 control-label">Penulis</label>
                            <div class="col-md-6">
                            <input id="news_author" type="text" class="form-control" name="news_author" placeholder="Masukkan Nama Penulis" value="{{ old('news_author') }}" required autofocus>
                                @if ($errors->has('news_author'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('news_author') }}</strong>
                                    </span>
                                @endif
                            </div>
                   </div>
                    <div class="form-group{{ $errors->has('news_title') ? ' has-error' : '' }}">
                            <label for="news_title" class="col-md-2 control-label">Judul Berita</label>
                            <div class="col-md-6">
                            <input id="news_title" type="text" class="form-control" name="news_title" placeholder="Masukkan Judul Berita" value="{{ old('news_title') }}" required autofocus>
                    ...
                    <div class="form-group{{ $errors->has('posted_date') ? ' has-error' : '' }}">
                            <label for="posted_date" class="col-md-2 control-label">Tanggal Post</label>
                            <div class="col-md-6">
                            <input id="posted_date" type="date" class="form-control" name="posted_date" placeholder="Masukkan Tanggal Pos" value="{{ old('posted_date') }}" required autofocus>
                    ...
                    <div class="form-group">
                        <label for="katnews_id" class="col-sm-2 control-label">Kategori News</label>
                          <div class="col-sm-6">
                    ...
                    <div class="form-group{{ $errors->has('news_ket') ? ' has-error' : '' }}">
                            <label for="news_ket" class="col-md-2 control-label">Keterangan</label>
                            <div class="col-md-6">
                            <input id="news_ket" type="textarea" class="form-control" name="news_ket" placeholder="Tambahkan Keterangan" value="{{ old('news_ket') }}" required autofocus>
                                @if ($errors->has('news_ket'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('news_ket') }}</strong>
                                    </span>
                                @endif
                          </div>
                   </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="news_photo">Foto</label>
                      <div class="col-sm-10">
  ...
  @if($act=="viewNews" || $act=="viewDeleteNews")
    ...
    @if ($act=="viewDeleteNews")
        ...
        <div class="alert alert-warning alert-dismissible">
          ...
          Hapus <strong> {{ $news_del->news_author }} </strong> ?
                     ...
                     <tr>
                      ...
                      <td>{{ $m->news_ket }}</td>
                       <td><img id="myImg" src="{{ asset ($m->news_photo) }}" alt="gambar.jpg" style="width:50%;max-width:100px"></td>
                        <td>
                        <a href="{{ url('sipar/news/vieweditnews',$m->news_id) }}" class="btn-sm btn-warning "><i class="fa fa-edit"></i></a> &nbsp;
                        <a href="{{ url('sipar/news/viewdeletenews',$m->news_id) }}" class="btn-sm btn-danger "><i class="fa fa-trash"></i></a>   
                      </td>
                    </tr>
