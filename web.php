...
Route::get('/', 'HomeController@adminDashboard')->name('home');
	...
	Route::prefix('emergency')->group(function () {
		...
		Route::get('viewpetaemergency/{emergency_id}','emergencyCont@viewPetaEmergency');
	...
	Route::prefix('event')->group(function () {
		...
		Route::get('viewDetailEvent/{event_id}','eventCont@viewDetailEvent');
	...
	Route::prefix('wisata')->group(function () {
		...
		Route::get('viewpetawisata/{wisata_id}','wisataCont@viewPetaWisata');
		Route::get('viewDetailWisata/{wisata_id}','wisataCont@viewDetailWisata');
