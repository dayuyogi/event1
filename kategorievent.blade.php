  ...
  @if($act=="viewTambahKatevent")
  	...
  	<div class="col-md-12">
  		<div class="box box-info">
                  ...
                  {!! csrf_field() !!}
  	              <div class="box-body">
                  <div class="form-group{{ $errors->has('kateven_name') ? ' has-error' : '' }}">
                            <label for="kateven_name" class="col-md-2 control-label">Kategori Event</label>

                            <div class="col-md-6">
                                <input id="kateven_name" type="text" class="form-control" name="kateven_name" placeholder="Masukkan Kategori Event" value="{{ old('kateven_name') }}" required autofocus>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @foreach ($kateven as $m)
                     <tr>
                      ...
                      <td>
                        <a href="{{ url('sipar/kateven/vieweditkatevent',$m->kateven_id) }}" class="btn-sm btn-warning "><i class="fa fa-edit"></i></a> &nbsp;
                        <a href="{{ url('sipar/kateven/viewdeletekatevent',$m->kateven_id) }}" class="btn-sm btn-danger "><i class="fa fa-trash"></i></a>   
                      </td>
                    </tr>
