...
class wisataCont extends Controller
{
    ...
    public function viewLaporan()
     ...
     public function viewDetailWisata($wisata_id){
        $wisata = DB::table('wisata')->where('wisata_id','=',$wisata_id)->first();
        $kec = DB::table('kecamatan')->where('kecamatan_id','=',$wisata->kecamatan_id)->first();
        $tiket = DB::table('tiket')->where('tiket_id','=',$wisata->tiket_id)->first();
        $katwis = DB::table('kategori_wisata')->where('katwis_id','=',$wisata->katwis_id)->first();
        ...
        ->with('tiket',$tiket)
        ->with('katwis',$katwis)
        ->with('act','viewDetailWisata');
     }

    public function viewPetaWisata($wisata_id){
	...
	public function prosesTambahWisata(Request $req){
        ...
        $hasil = DB::table('wisata')->insert(
            ...
            'katwis_id'=>$katwis_id,'harga'=>$harga,'wisata_alamat'=> $wisata_alamat, 'open_time'=>$open_time, 'close_time'=>$close_time,'longitude'=>$longitude,'latitude'=>$latitude,
            'gambar'=>$gambar]);
    ...
    public function prosesEditWisata(Request $req){
        ...
        $hasil = DB::table('wisata')
            ...
            ->update(['wisata_name' => $wisata_name, 'tiket_id'=>$tiket_id,'kecamatan_id'=>$kecamatan_id,'katwis_id'=>$katwis_id,'harga'=>$harga,'wisata_alamat'=> $wisata_alamat, 'open_time'=>$open_time, 'close_time'=>$close_time,'longitude'=>$longitude,'latitude'=>$latitude,'gambar'=>$gambar]);
