  ...
  @if($act=="viewTambahKecamatan")
  	...
  	<div class="col-md-12">
  		<div class="box box-info">
                  ...
                  {!! csrf_field() !!}
  	              <div class="box-body">
  	                 <div class="form-group{{ $errors->has('kecamatan_name') ? ' has-error' : '' }}">
                            <label for="kecamatan_name" class="col-md-2 control-label">Kecamatan</label>
                            <div class="col-md-6">
                            <input id="kecamatan_name" type="text" class="form-control" name="kecamatan_name" placeholder="Masukkan Kecamatan" value="{{ old('kecamatan_name') }}" required autofocus>
                                @if ($errors->has('kecamatan_name'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('kecamatan_name') }}</strong>
                                    </span>
                                @endif
                            </div>
                  </div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @foreach ($kec as $m)
                     <tr>
                      ...
                      <td>
                        <a href="{{ url('sipar/kecamatan/vieweditkecamatan',$m->kecamatan_id) }}" class="btn-sm btn-warning "><i class="fa fa-edit"></i></a> &nbsp;
                        <a href="{{ url('sipar/kecamatan/viewdeletekecamatan',$m->kecamatan_id) }}" class="btn-sm btn-danger "><i class="fa fa-trash"></i></a>   
                      </td>
                    </tr>
