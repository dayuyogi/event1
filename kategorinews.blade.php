  ...
  @if($act=="viewTambahKatnews")
  	...
  	<div class="col-md-12">
  		<div class="box box-info">
                  ...
                  {!! csrf_field() !!}
                <div class="box-body">
  	             <div class="form-group{{ $errors->has('katnews_name') ? ' has-error' : '' }}">
                            <label for="katnews_name" class="col-md-2 control-label">Kategori News</label>
                            <div class="col-md-6">
                            <input id="katnews_name" type="text" class="form-control" name="katnews_name" placeholder="Masukkan Kategori News" value="{{ old('katnews_name') }}" required autofocus>
                                @if ($errors->has('katnews_name'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('katnews_name') }}</strong>
                                    </span>
                                @endif
                            </div>
                  </div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @foreach ($kanws as $m)
                     <tr>
                      ...
                      <td>
                        <a href="{{ url('sipar/kanws/vieweditkatnews',$m->katnews_id) }}" class="btn-sm btn-warning "><i class="fa fa-edit"></i></a> &nbsp;
                        <a href="{{ url('sipar/kanws/viewdeletekatnews',$m->katnews_id) }}" class="btn-sm btn-danger "><i class="fa fa-trash"></i></a>   
                      </td>
                    </tr>
